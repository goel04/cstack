...
export const ReportModal: React.FC<ReportModalProps> = ({ isOpen, onClose, result }) => {
  ...
  const handleCopySummary = () => {
    const text = `CSTACK CARBON FOOTPRINT SUMMARY
      ...
      >
        ...
        <div className="pt-6 space-y-6 text-slate-900" id="printable-carbon-report">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Ref: CSTK-CO2-{Math.abs(result.totalKgCO2e % 999999).toString().padStart(6, '0')}
              </p>
            </div>
          ...
          <div className="pt-4 border-t border-slate-200 text-[11px] text-slate-400 space-y-1">
            ...
            <p>
              This report is generated by CSTACK’s Carbon Calculation Engine using methodology grounded in the GHG Protocol Corporate Standard, UK DEFRA 2024, and CEA v19 datasets. Offset requirements represent equivalent carbon volume and do not constitute an issuance or transfer of carbon credits.
            </p>
          </div>
        </div>
      </div>

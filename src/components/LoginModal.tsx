...
import { X, Lock, Mail, ArrowRight, ShieldCheck, CheckCircle2, User, Building, AlertCircle, Sparkles } from 'lucide-react';
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-display font-bold text-slate-950">
            {mode === 'signin' ? 'Welcome Back to CSTACK' : 'Create CSTACK Account'}
          </h3>
          <p className="text-xs text-slate-500 mt-1">
            {mode === 'signin'
              ? 'Sign in to access your personal carbon dashboard and saved models.'
              : 'Start measuring, logging activities, and storing your climate records in Firestore.'}
          </p>
        </div>
        ...
        {isSuccess ? (
          <div className="py-8 text-center space-y-3 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-slate-500">
              Connecting to your private Firestore carbon workspace...
            </p>
          </div>
        ) : (
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-2 px-3 bg-emerald-50 hover:bg-emerald-100/80 border border-emerald-200 text-emerald-900 rounded-xl text-xs font-semibold transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-2 text-center">
              <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-500">
                ...
                <span>Encrypted via Firebase Firestore & Auth Rules</span>
              </div>
            </div>
          </div>
        )}
